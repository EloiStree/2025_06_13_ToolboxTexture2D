...
{
    public class TextureMono_CountCrossRadiusCompute : MonoBehaviour {
        ...
        public int m_squareRadiusMax = 255;
        ...
        public void ComputeTheTexture()
        {
            ...
            m_computeShader.SetInt("m_squareRadiusMax", m_squareRadiusMax);
